...
## Recap: measure the distance between earth and the sun
  * 1. Use relative distance betweem venus-earth and sun-earth to get the exact distance between earth and the sun.
    * venus relative distance: xv/x = cos phi, where phi is different viewing angle at half illuminated venus. 
  * 2. Use parallax to find distance between earth and venus.
